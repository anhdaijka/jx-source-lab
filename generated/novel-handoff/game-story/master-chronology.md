# Kiếm Thế source-canon master chronology

This is a source-only chronology for forensic import. It is not a novel outline, adaptation plan or prose.

## 1. Du Long Giác prologue and world crisis
...
## 2. Player opening and Bạch Thu Lâm
...
- Tolerated unknowns: `parents-identities`, `player-guardian-lineage`
...
## 6. Chuyện Cũ Thần Châu convergence
...
- `IR025` [VERIFIED_CROSS_SOURCE]: The wrapper sequence 22→23→24 (79–89) moves from the Du Long recovery effort through an attack on Nghĩa Quân and a contested treasure cave involving Hoàn Nhan Tương, ending at Đại Nghĩa Nước Nhà; a contemporary Xoyo patch independently names the mainline task 家国大义.
- Tolerated unknowns: `post50-micro-dialogue-recovery`

## 8. Khánh Nguyên and Nghĩa Quân
...
## 12. Decision for Northern Expedition
...
## 14. Verified publication endpoint
